...
func TestCseberino(t *testing.T) {
	trie := newEmpty()

	decoded, err := hex.DecodeString("")
	if err != nil {
		t.Error(err)
	}

	key, _ := rlp.EncodeToBytes(uint(0))
	trie.Update(key, decoded)

	t.Log("tzdybal:", trie.Hash().Hex())
	t.FailNow()
}
